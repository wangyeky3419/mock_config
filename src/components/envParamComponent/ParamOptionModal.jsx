...
export default class ParamOptionModal extends Component {
        ...
        return(
            <div>
                ...
                <Row style={{marginLeft:'-10px'}}>
                    <Col span="12">
                        <FormItem label="服务方URL：" {...formItemLayout} style={{marginLeft:'-30px'}}>
                            <Input {...init('httpServerURL')} style={{width:'70%'}}/>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <FormItem label="传输内容编码格式：" {...formItemLayout}>
                            <Select style={{width :'70%'}} {...init('httpContentEncoding')} hasClear={true}>
                ...
                <Row style={{marginLeft:'-10px'}}>
                    <Col span="12">
                        <FormItem label="最大线程数：" {...formItemLayout} style={{marginLeft:'-30px'}}>
                            <Input {...init('maxThreadNumber')} style={{width:'70%'}}/>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <FormItem label="传输内容解码格式：" {...formItemLayout}>
                            <Select style={{width :'70%'}} {...init('httpContentDecoding')}>
                                <Select.Option value="GBK">GBK</Select.Option>
                                <Select.Option value="UTF-8">UTF-8</Select.Option>
                            </Select>
                        </FormItem>
                ...
                <Row style={{marginLeft:'-10px'}}>
                    <Col span="12">
                        <FormItem label="请求方法：" {...formItemLayout} style={{marginLeft:'-30px'}}>
                            <Select {...init('httpMethod')} style={{width:'70%'}} hasClear={true}>
                ...
                <Row style={{marginLeft:'-10px'}}>
                    <Col span="24">
                        <FormItem label="特殊URL集合：" {...formItemLayout} style={{marginLeft:'-30px'}}>
        ...
        return(
            <div>
                ...
                <div style={{display:this.state.sortType=='length'?'block':'none'}}>
                    ...
                    <Row style={{marginLeft:'-10px',marginTop:'10px'}}>
                    <Col span="12">
                        <FormItem label="字节偏移量：" {...formItemLayout} style={{marginLeft:'-30px'}}>
                            <Input {...init('lengthFieldOffset')} style={{width:'70%'}}/>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <FormItem label="最大缓冲区：" {...formItemLayout} style={{marginLeft:'-30px'}}>
        ...
        return (
            <div>
                ...
                <Row style={{marginLeft:'-10px'}}>
                    <Col span="12">
                        <FormItem label="字符集：" {...formItemLayout} style={{marginLeft:'-30px'}}>
                            <Select style={{width :'70%'}} {...init('charset')} hasClear={true}>
                                <Select.Option value="GBK">GBK</Select.Option>
                                <Select.Option value="UTF-8">UTF-8</Select.Option>
                            </Select>
                        </FormItem>
