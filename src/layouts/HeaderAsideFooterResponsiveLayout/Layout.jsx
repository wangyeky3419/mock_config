...
// let theme = typeof THEME === 'undefined' ? 'dark' : THEME;
    ...
    render() {
        ...
        >
            ...
            >
                ...
                <Switch checkedChildren="白" onChange={this.onChangeTheme.bind(this)} defaultChecked={checkedTop} unCheckedChildren="红" style={{position:'absolute',bottom:'70px',left:'1%'}}/>
                {/* 侧边菜单项 end */}
            </Layout.Aside>
            {/* 主体内容 */}
