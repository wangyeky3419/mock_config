...
import { Button, Pagination, Feedback, Loading, Upload } from '@icedesign/base';
...
const MOCK_DATA = [
    ...
    },
    {
        id:'2',
        systemCode: 'COBP',
        messageCode: '10070038',
        messageName: '附属账户体系查询',
        messageType:'key-value-separator',
        prefix:'022',
        suffix:'11',
        keyValueSeparator:'213',
        keyValuePairSeparator:'IO',
...
export default class TableTrans extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        this.filter = 
            [
                {label:'交易编码', value:'messageCode',key:'messageCode'},
                {label:'交易名称', value:'messageName',key:'messageName'},
                {
                    label:'报文类型', 
                    value:'messageType',
                    key:'messageType',
    ...
    render() {
        ...
        return (
            <div className="tab-table">
                <IceContainer>
                    <Button type="primary" size="small" onClick={() => this.onEditOpen()} style={{marginBottom:'4px',marginLeft:'2px'}}>修改</Button> 
                    ...
                    >
                        <Button type="primary" size="small" style={{marginBottom:'4px',marginLeft:'4px'}}>
                        模板导入
                        </Button>
                    </Upload>               
                    {/* <Button type="primary" size="small" onClick={() => this.importTemp()} style={{marginBottom:'4px',marginLeft:'4px'}}></Button>                 */}
